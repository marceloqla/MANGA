...
def main_run_phmmer(arguments):
    global baseUrl, version, pollFreq, outputLevel, debugLevel, numOpts, options, parser, outputLevel, debugLevel, pollFreq, multifasta, useSeqId, maxJobs
